    ...
    test('items added after screen is full should be scrollable', () async {
      await testNocterm(
        ...
        (tester) async {
          ...
          print('ScrollController maxScrollExtent: ${scrollController.maxScrollExtent}');
          ...
          expect(
            ...
            isTrue,
            reason: 'After scrolling to end, at least one of the last items should be visible',
          );
        },
                ...
                Expanded(
                  child: Container(
                    ...
                    child: ListView.builder(
                      ...
                      itemCount: items.length, // Key difference: itemCount is known
